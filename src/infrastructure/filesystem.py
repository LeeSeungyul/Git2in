...
class FilesystemManager:
    ...
    def delete_namespace_directory(self, namespace_name: str, force: bool = False) -> None:
    ...
    def calculate_directory_size(self, path: Path) -> int:
        ...
        try:
            ...
            logger.warning(
                "directory_size_calculation_failed",
                path=str(path),
                error=str(e)
            )
    ...
    def verify_repository_structure(self, namespace_name: str, repo_name: str) -> bool:
        ...
        try:
            ...
            if not (head_content.startswith("ref: refs/") or 
                   re.match(r"^[0-9a-f]{40}$", head_content)):
                return False
        except Exception:
            return False
