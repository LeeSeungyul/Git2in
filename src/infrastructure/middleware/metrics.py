...
from src.infrastructure.metrics import (http_request_duration_seconds,
...
class MetricsMiddleware(BaseHTTPMiddleware):
    ...
    def _normalize_endpoint(self, path: str) -> str:
        ...
        patterns = [
            ...
            (
                r"/api/v\d+/namespaces/[^/]+/repos",
                "/api/{version}/namespaces/{namespace}/repos",
            ),
            (
                r"/api/v\d+/namespaces/[^/]+/repos/[^/]+",
                "/api/{version}/namespaces/{namespace}/repos/{repo}",
            ),
            # Auth endpoints
