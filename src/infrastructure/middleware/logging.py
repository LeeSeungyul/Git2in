...
from src.infrastructure.logging import get_logger, bind_context, clear_context, unbind_context
...
class LoggingMiddleware(BaseHTTPMiddleware):
    ...
    async def _sample_request_body(self, request: Request, max_size: int = 1000) -> Optional[str]:
