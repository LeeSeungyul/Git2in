...
class APIClient:
    ...
    def __init__(self, base_url: str, auth_token: Optional[str] = None, debug: bool = False):
        """
    ...
    def post(self, path: str, json_data: Optional[Dict[str, Any]] = None, **kwargs) -> Any:
        """Make POST request."""
        return self.request("POST", path, json_data=json_data, **kwargs)
    
    def put(self, path: str, json_data: Optional[Dict[str, Any]] = None, **kwargs) -> Any:
        """Make PUT request."""
        return self.request("PUT", path, json_data=json_data, **kwargs)
    
    def patch(self, path: str, json_data: Optional[Dict[str, Any]] = None, **kwargs) -> Any:
        """Make PATCH request."""
    ...
    def list_namespaces(self, limit: int = 100, offset: int = 0) -> List[Dict[str, Any]]:
        """List namespaces."""
        response = self.get("/api/v1/namespaces", params={"limit": limit, "offset": offset})
    ...
    def list_repositories(self, namespace: Optional[str] = None, limit: int = 100, offset: int = 0) -> List[Dict[str, Any]]:
        """List repositories."""
