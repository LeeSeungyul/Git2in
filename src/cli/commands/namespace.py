...
def create_namespace(
    ...
    description: Optional[str] = typer.Option(None, "--description", "-d", help="Namespace description"),
...
def list_namespaces(
    ctx: typer.Context,
    filter: Optional[str] = typer.Option(None, "--filter", "-f", help="Filter namespaces by name"),
...
def update_namespace(
    ...
    public: Optional[bool] = typer.Option(None, "--public/--private", help="Set visibility"),
):
    """
