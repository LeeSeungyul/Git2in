...
from src.core.exceptions import BaseAPIException, ValidationError, InternalServerError
...
async def general_exception_handler(request: Request, exc: Exception) -> JSONResponse:
    ...
    internal_error = InternalServerError(
        ...
        details={"error_type": type(exc).__name__} if not getattr(request.app.state, "is_production", True) else None
    )
