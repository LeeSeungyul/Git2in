...
class PaginationParams(BaseModel):
    ...
    limit: Optional[int] = Field(None, ge=1, le=1000, description="Limit for pagination")
...
class FilterParams(BaseModel):
    ...
    updated_after: Optional[str] = Field(None, description="Filter by update date (ISO 8601)")
    updated_before: Optional[str] = Field(None, description="Filter by update date (ISO 8601)")
