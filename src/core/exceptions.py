...
class ValidationError(BaseAPIException):
    def __init__(
        ...
        super().__init__(
            code="G2IN-400", message=message, status_code=400, details=details
        )
...
class AuthenticationError(BaseAPIException):
    def __init__(
        ...
        super().__init__(
            code="G2IN-401", message=message, status_code=401, details=details
        )
...
class AuthorizationError(BaseAPIException):
    def __init__(
        ...
        super().__init__(
            code="G2IN-403", message=message, status_code=403, details=details
        )
...
class ConflictError(BaseAPIException):
    def __init__(
        ...
        super().__init__(
            code="G2IN-409", message=message, status_code=409, details=details
        )
...
class PayloadTooLargeError(BaseAPIException):
    def __init__(
        ...
        super().__init__(
            code="G2IN-413", message=message, status_code=413, details=details
        )
...
class RateLimitError(BaseAPIException):
    def __init__(
        ...
        super().__init__(
            code="G2IN-429", message=message, status_code=429, details=details
        )
...
class InternalServerError(BaseAPIException):
    def __init__(
        ...
        super().__init__(
            code="G2IN-500", message=message, status_code=500, details=details
        )
