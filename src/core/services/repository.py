...
from src.core.models import Repository, Namespace, AuditEntry, AuditAction, ResourceType
...
class RepositoryService:
    ...
    def delete_repository(
        ...
        """Delete a repository"""
        repo_path = self.fs_manager.get_repository_path(namespace_name, f"{repo_name}.git")
    ...
    def get_repository_info(
        ...
        if not self.fs_manager.verify_repository_structure(namespace_name, repo_name):
            raise InternalServerError(f"Invalid repository structure: {namespace_name}/{repo_name}")
        ...
        info = {
            ...
            "path": str(repo_path),
            "size_bytes": self.fs_manager.calculate_repository_size(namespace_name, repo_name),
        }
