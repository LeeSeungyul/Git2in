...
from src.core.auth.models import Token, TokenClaims
...
class TokenStore(ABC):
    ...
    @abstractmethod
    async def set(
        self, token_id: str, claims: TokenClaims, ttl_seconds: Optional[int] = None
    ) -> None:
...
class InMemoryTokenStore(TokenStore):
    ...
    async def delete_by_user(self, user_id: str) -> int:
        ...
        with self._lock:
            ...
            logger.info("user_tokens_deleted", user_id=user_id, count=count)
