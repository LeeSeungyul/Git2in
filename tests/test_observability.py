...
class TestGitMetrics:
    ...
    def test_ref_advertisement_metrics(self):
        ...
        from src.infrastructure.metrics import git_ref_advertisement_duration_seconds
        assert git_ref_advertisement_duration_seconds._name == "git_ref_advertisement_duration_seconds"